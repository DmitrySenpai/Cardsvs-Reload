...
class room_system:
    ...
    def create_room(self, id_owner):
        self.room_game[self.id_room] = {"owner": id_owner, "socket": "", "chat": [], "round": 1, "guest_assistant": -1, "status": "waiting", "winner": -1, "player": {}, "word": -1, "timer": -1, "status_2": "wait", "leading": 0, "fite_card": [], "fite_card_sel": -1}
