...
if (!self.__WB_pmw) {
    self.__WB_pmw = function(obj) {Slovarnew
...
}
{
    ...
    /*! jQuery Easing v1.3 | (c) 2008 George McGinley Smith, 2001 Robert Penner | Open source under the BSD License */
        ...
        if (!ion.sound) {
            ...
            if ("function" !== typeof Audio && "object" !== typeof Audio)
                ...
                p.prototype = {
                    ...
                    createUrl: function() {
                        this.url = this.options.path + this.options.name + "." + this.options.supported[this.ext] + "?" + (new Date).valueOf()
                    },
                    load: function() {
                    ...
                    ready: function(a) {
                        ...
                        4 !== this.result.readyState ? this.reload() : 200 !== this.result.status ? (m(this.url + " was not found on server!"),
                ...
                k.prototype = {
                    ...
                    setLoop: function(a) {
                        !0 === a.loop ? this.loop = 9999999 : "number" === typeof a.loop && (this.loop = +a.loop - 1)
                    },
                    update: function(a) {
                        this.setLoop(a);
                    ...
                    _play: function() {
                        ...
                        b = this.end);
                        0 >= b ? this.clear() : (this.source.start(0, a, b),
                        this.playing = !0,
                        this.paused = !1,
                ...
                k.prototype = {
                    ...
                    createUrl: function() {
                        this.url = this.path + this.name + "." + c.supported[0] + "?" + (new Date).valueOf()
                    },
...
/*
     FILE ARCHIVED ON 04:57:42 Oct 07, 2022 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 14:46:49 Nov 11, 2023.
...
/*
playback timings (ms):
  captures_list: 75.349
  exclusion.robots: 0.149
  exclusion.robots.policy: 0.133
  cdx.remote: 0.109
  esindex: 0.016
  LoadShardBlock: 38.368 (3)
  PetaboxLoader3.datanode: 73.143 (5)
  load_resource: 106.658
  PetaboxLoader3.resolve: 55.967
  loaddict: 20.447
*/
